...
type Client struct {
	*goaclient.Client
	...
	JWTQueryParamSigner goaclient.Signer
...
// SetJWTQueryParamSigner sets the request signer for the jwt-query-param security scheme.
func (c *Client) SetJWTQueryParamSigner(signer goaclient.Signer) {
	c.JWTQueryParamSigner = signer
}
